...
| [OpenAI-compatible API](openai-compatible.md) | OpenAI chat completions over HTTP. | The client or the gateway. |
...
only a base URL too. Fountain answers `POST /v1/chat/completions` and
