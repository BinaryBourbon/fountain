...
Implementation plans and specs written for agentic workers in May 2026, during
the migration of `aod-ex` into this codebase. They are a historical record of
how the work was scoped, not current documentation — read the code, the
