defmodule Fountain.Sandbox.E2B.Api do
  @moduledoc """
  ...
  `Fountain.Sandbox.E2B` normalizes them into the taxonomy.
  ...
  def req do
    Req.new(
      ...
      ] ++ Application.get_env(:fountain, :e2b_req_options, [])
    )
  end

  def base_url, do: Application.get_env(:fountain, :e2b_base_url, "https://api.e2b.app")

  def api_key! do
    Application.get_env(:fountain, :e2b_api_key) ||
  ...
  def template do
    Application.get_env(:fountain, :e2b_template, "base")
  end
