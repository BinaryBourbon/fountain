    ...
    <div class="space-y-6 max-w-2xl">
      <div>
        ...
        <p class="text-sm text-[var(--color-text-secondary)] mt-2">
          ...
          refuses every other account. That is why you can point it anywhere you like — your
          sandbox's public URL, a <code class="font-mono text-xs">localhost</code>
          port. A loopback URI matches on any port.
        </p>
      </div>
      ...
      >
        <div class="flex items-start justify-between gap-2">
          ...
          <div class="flex gap-1 shrink-0">
            <.button variant="ghost" phx-click="edit" phx-value-id={c.id}>Edit</.button>
            <.button
              variant="ghost"
              phx-click="delete"
              phx-value-id={c.id}
