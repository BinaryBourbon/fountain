defmodule FountainWeb.Router do
  ...
  # OAuth clients an account registers for itself (#1125). Full scope, for the
  # reason API key management is full scope: a client is a standing way to get
  # a full-scope key with one consent, so a conversation-scoped token must not
