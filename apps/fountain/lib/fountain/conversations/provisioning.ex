defmodule Fountain.Conversations.Provisioning do
  ...
  # Local interruption cannot authorize deletion or reuse of a physical name.
  # Keep this entry point fenced for callers with a saved interrupted snapshot;
  # recovery must reconcile the original provider operation and instance first.
  def discard_interrupted_attempt(_provider, _sandbox, false), do: :ok

  def discard_interrupted_attempt(_provider, _sandbox, true),
