...
| `cli/`, `sdk/typescript` and `sdk/swift` | [Apache-2.0](https://github.com/BinaryBourbon/fountain/blob/main/cli/LICENSE) | Build on the API and ship a client inside a closed product, with no obligations. |
...
| The SDKs | `@agentshit/fountain-sdk` on npm, or the [TypeScript](sdk.md) and [Swift](swift-sdk.md) references. |
