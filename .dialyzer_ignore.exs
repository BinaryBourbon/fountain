...
[
  # x509 0.9.2 (the broker CA, ADR 0019) references two types dialyzer does
  # not know: its own X509.ASN1.record/1 macro-type and :public_key's
  # unexported ec_private_key/0. Both are inside the dependency, not ours.
