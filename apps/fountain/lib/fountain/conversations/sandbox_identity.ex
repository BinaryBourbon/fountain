defmodule Fountain.Conversations.SandboxIdentity do
  ...
  @doc "Read identity outside database locks, then bind it to the unchanged owned row."
  ...
  @doc "Bind trusted provider control metadata once; never accept identity from worker output."
