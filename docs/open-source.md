...
| `cli/`, `sdk/typescript` and `sdk/python` | [Apache-2.0](https://github.com/BinaryBourbon/fountain/blob/main/cli/LICENSE) | Build on the API and ship a client inside a closed product, with no obligations. |
...
| The SDKs | `@agentshit/fountain-sdk` on npm, `fountain-agent-sdk` on PyPI, or the [TypeScript](sdk.md) and [Python](python-sdk.md) references. |
